...
- La ficha `coach-student` ahora destaca faltantes criticos de perfil y salud para que el coach vea rapido si el alumno tiene contexto suficiente para seguimiento seguro.
